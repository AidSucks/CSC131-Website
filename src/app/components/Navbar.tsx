...
export default function Navbar() {
    ...
    // Separate states for each dropdown menu
            ...
            <nav className={`navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0 ${isScrolledDown ? 'sticky-top shadow-sm' : ''}`}>
                ...
                <div className={`collapse navbar-collapse ${isOpen ? 'show' : ''}`} id="navbarCollapse">
                    <div className="navbar-nav ms-auto py-0">
                        <Link href="/" className={clsx("nav-item nav-link", { "active": currentPath === "/" })}>Home</Link>
                        <Link href="/about" className={clsx("nav-item nav-link", { "active": currentPath === "/about" })}>About Us</Link>
                        ...
                        >
                            <Link href="/services" className="nav-link dropdown-toggle">Services</Link>
                            <div className={`dropdown-menu m-0 ${isServicesHovered ? 'show' : ''}`}>
                        ...
                        >
                            ...
                            <div className={`dropdown-menu m-0 ${isResourcesHovered ? 'show' : ''}`}>
                        ...
                        <Link href="/contact" className={clsx("nav-item nav-link", { "active": currentPath === "/contact" })}>Contact Us</Link>
                    </div>
